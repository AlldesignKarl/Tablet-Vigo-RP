-- ===================================================================
-- VIGO RP TABLET — Continuación (0002 a 0007) para pegar de una sola vez
-- Úsalo SOLO si ya ejecutaste 0001_schema.sql antes.
-- Si NO has ejecutado 0001_schema.sql todavía, hazlo primero y luego este.
-- ===================================================================
